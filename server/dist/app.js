        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    return [4 /*yield*/, pool.query("SELECT ROW_NUMBER() OVER(ORDER BY teampoints desc) , team.* FROM team order by teamPoints desc, teamScore desc")];
                case 1:
                    sql = (_d.sent()).rows;
                    console.log(sql);
                    res.render('results', {
...
app.use('/rounds', function (req, res) {
    var _a, _b, _c;
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, pool.query("SELECT DISTINCT roundid from match order by roundid desc")];
                case 3:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    console.log(score1);
                    console.log(score2);
                    return [4 /*yield*/, pool.query("SELECT firstteamid,firstteamscore, secondteamid,secondteamscore FROM match WHERE matchid = " + id)];
                case 1:
                    getsql = (_a.sent()).rows[0];
                    console.log(getsql);
                    // add score
                    return [4 /*yield*/, pool.query("UPDATE team SET teamScore = (SELECT (teamScore + " + score1 + ") FROM team t2 WHERE t2.teamid = " + getsql['firstteamid'] + ") WHERE teamid = " + getsql['firstteamid'])];
                case 2:
                    // add score
                    _a.sent();
                    return [4 /*yield*/, pool.query("UPDATE team SET teamScore = (SELECT (teamScore + " + score2 + ") FROM team t2 WHERE t2.teamid = " + getsql['secondteamid'] + ") WHERE teamid = " + getsql['secondteamid'])];
                case 3:
                    _a.sent();
                    if (!(getsql['firstteamscore'] != null && getsql['secondteamscore'] != null)) return [3 /*break*/, 10];
                    if (!(getsql['firstteamscore'] == getsql['secondteamscore'])) return [3 /*break*/, 6];
                    return [4 /*yield*/, pool.query("UPDATE team SET teamPoints = (SELECT (teamPoints - 1) FROM team t2 WHERE t2.teamid = " + getsql['firstteamid'] + ") WHERE teamid = " + getsql['firstteamid'])];
                case 4:
                    _a.sent();
                    return [4 /*yield*/, pool.query("UPDATE team SET teamPoints = (SELECT (teamPoints - 1) FROM team t2 WHERE t2.teamid = " + getsql['secondteamid'] + ") WHERE teamid = " + getsql['secondteamid'])];
                case 5:
                    _a.sent();
                    return [3 /*break*/, 10];
                case 6:
                    if (!(getsql['firstteamscore'] > getsql['secondteamscore'])) return [3 /*break*/, 8];
                    return [4 /*yield*/, pool.query("UPDATE team SET teamPoints = (SELECT (teamPoints - 3) FROM team t2 WHERE t2.teamid = " + getsql['firstteamid'] + ") WHERE teamid = " + getsql['firstteamid'])];
                case 7:
                    _a.sent();
                    return [3 /*break*/, 10];
                case 8: return [4 /*yield*/, pool.query("UPDATE team SET teamPoints = (SELECT (teamPoints - 3) FROM team t2 WHERE t2.teamid = " + getsql['secondteamid'] + ") WHERE teamid = " + getsql['secondteamid'])];
                case 9:
                    _a.sent();
                    _a.label = 10;
                case 10:
                    ...
                    // update match
                    return [4 /*yield*/, pool.query("UPDATE match SET matchWinnerID = " + winnerid + ",firstteamscore = " + score1 + ", secondteamscore = " + score2 + " WHERE matchid = " + id)];
                case 11:
                    // update match
                    _a.sent();
                    if (!(score1 == score2)) return [3 /*break*/, 14];
                    return [4 /*yield*/, pool.query("UPDATE team SET teamPoints = (SELECT (teamPoints + 1) FROM team t2 WHERE t2.teamid = " + getsql['firstteamid'] + ") WHERE teamid = " + getsql['firstteamid'])];
                case 12:
                    _a.sent();
                    return [4 /*yield*/, pool.query("UPDATE team SET teamPoints = (SELECT (teamPoints + 1) FROM team t2 WHERE t2.teamid = " + getsql['secondteamid'] + ") WHERE teamid = " + getsql['secondteamid'])];
                case 13:
                    ...
                    return [3 /*break*/, 18];
                case 14:
                    if (!(score1 > score2)) return [3 /*break*/, 16];
                    return [4 /*yield*/, pool.query("UPDATE team SET teamPoints = (SELECT (teamPoints + 3) FROM team t2 WHERE t2.teamid = " + getsql['firstteamid'] + ") WHERE teamid = " + getsql['firstteamid'])];
                case 15:
                    _a.sent();
                    return [3 /*break*/, 18];
                case 16: return [4 /*yield*/, pool.query("UPDATE team SET teamPoints = (SELECT (teamPoints + 3) FROM team t2 WHERE t2.teamid = " + getsql['secondteamid'] + " WHERE teamid = " + getsql['secondteamid'])];
                case 17:
                    _a.sent();
                    _a.label = 18;
                case 18:
...
// edit comment
app.post('/comment/edit/:id', function (req, res) {
    var _a, _b, _c;
    return __awaiter(this, void 0, void 0, function () {
